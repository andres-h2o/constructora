...
@section('contenido')
    ...
    <div class="container">
        <div class="row">
          <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Top Five General del Proyecto</div>
                    <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                @foreach($trabajadores as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(array_values(array_values($lista)[$loop->iteration-1])[5]!="")
                                                <div class="circular--portrait">
                                                    <a href="{{array_values(array_values($lista)[$loop->iteration-1])[5]}}" data-toggle="modal" data-target="{{"#".$loop->iteration."ventana"}}">
                                                        <img src="{{array_values(array_values($lista)[$loop->iteration-1])[5]}}" class="imgRedonda" ></a>
                                                </div>
                                                <div class="modal fade" id="{{$loop->iteration."ventana"}}" tabindex="-1" role="dialog" align="center"   aria-label="miModalLavel1" aria-hidden="true" >
                                                    ...
                                                    <img  class="center" src="{{array_values(array_values($lista)[$loop->iteration-1])[5]}}"  ></a>
