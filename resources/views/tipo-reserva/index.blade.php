...
@section('contenido')
    <div class="container">
        ...
        <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Tiporeserva</div>
                    <div class="card-body">
                        <a href="{{ url('/tipo-reserva/create') }}" class="btn btn-success btn-sm" title="Add New TipoReserva">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <form method="GET" action="{{ url('/tipo-reserva') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                                ...
                                @foreach($tiporeserva as $item)
                                    <tr>
                                        ...
                                        {{--<td>
                                            ...
                                            <form method="POST" action="{{ url('/tipo-reserva' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                            ...
                            <div class="pagination-wrapper"> {!! $tiporeserva->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
